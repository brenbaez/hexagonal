...
public class OrderCreator {
    ...
    public void create(String aggregateId, Map<ProductId, ProductQuantity> quantityPerProduct, Address address,
                       DiscountCode discountCode, Email email) {
        List<Product> products = get(quantityPerProduct.keySet());
        Order order = new Order(products, quantityPerProduct, aggregateId, address, discountCode, email);
